      ...
      <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto px-4 py-3 space-y-3">
        ...
        <div className="flex gap-2 pt-1 pb-2">
          ...
          <button
            type="submit"
            disabled={submitting}
            className="flex-1 px-4 py-2.5 text-sm bg-teal-600 text-white rounded-lg hover:bg-teal-700 disabled:opacity-60 disabled:cursor-not-allowed transition-colors font-medium"
          >
